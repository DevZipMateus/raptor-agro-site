...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-[120vh] sm:min-h-[110vh] lg:min-h-screen h-auto">
      <video
        autoPlay
        loop
        muted
      ...
      <div className="absolute inset-0 flex items-center justify-center py-24 sm:py-32">
